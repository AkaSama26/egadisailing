...
EMAIL_DELIVERY_MODE=smtp              # oppure brevo se usi REST API
BREVO_API_KEY=                        # richiesto solo con EMAIL_DELIVERY_MODE=brevo
BREVO_SMTP_HOST=smtp-relay.brevo.com
BREVO_SMTP_PORT=587
BREVO_SMTP_USER=aa6481001@smtp-brevo.com
