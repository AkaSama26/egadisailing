...
Next mandatory review: 2026-08-19 or before any production release, whichever
comes first.

## Release gate

CI fails on every HIGH or CRITICAL advisory in the complete dependency tree,
runtime-only tree and final container image. Lower-severity findings are not
silently waived: they remain listed below with scope and compensating controls.
...
- pinned distroless runtime base: 0 critical, 0 high at the review date.
