...
## Money keyword principali
| Cluster | IT | EN | ES | FR | DE | Pagina proprietaria |
|---|---|---|---|---|---|---|
| Hub tour | tour in barca alle Egadi da Trapani | Egadi Islands boat tours from Trapani | excursiones en barco Islas Egadi desde Trapani | excursions en bateau iles Egades depuis Trapani | Bootstouren Aegadische Inseln ab Trapani | `pages/experiences-hub.md` |
...
## Regole frequenza
- Primary exact: title 1x, H1 1x, intro 1x. Body/FAQ solo quanto serve.
- Secondary: 1-3x per pagina, mai tutte nello stesso paragrafo.
- Local entity: Trapani, Favignana, Levanzo, Marettimo, Cala Rossa, Cala Azzurra, Bue Marino, AMP Isole Egadi.
- Non usare keyword commerciali su pagine informative se generano aspettative non vendute.
- Non usare "senza skipper" salvo decisione business futura e servizio reale.
