 ...
 */
export function OceanLayout({ children, padding = "lg", className = "" }: OceanLayoutProps) {
  return (
    <div
      className={`min-h-screen bg-gradient-to-b from-[#071934] to-[#0c3d5e] ${PADDING_Y[padding]} px-4 ${className}`}
    >
      {children}
    </div>
  );
