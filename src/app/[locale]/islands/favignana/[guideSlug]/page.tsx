...
const compareExperiencesByLocale = {
  ...
  es: [
    ...
    },
    {
      ...
      description: "Trimarán con confort de catamarán, chef, patrón, azafata y comida con productos locales.",
      href: "/experiences/exclusive-experience",
      image: "/images/boats/neel-47/neel-47-tavolo-a-bordo.webp",
      meta: "Premium",
    },
  ...
  de: [
    ...
    },
    {
      ...
      description: "Trimaran mit Katamaran-Komfort, Chef, Skipper, Hostess und Mittagessen mit lokalen Produkten.",
      href: "/experiences/exclusive-experience",
      image: "/images/boats/neel-47/neel-47-tavolo-a-bordo.webp",
      meta: "Premium",
    },
...
const ctaCopyByLocale = {
  it: {
    cigala: {
      ...
      imageAlt: "Barca Egadi Sailing alle Isole Egadi",
      icon: Waves,
    },
    neel: {
      ...
      imageAlt: "Trimarano con comfort da catamarano in navigazione a Favignana",
      icon: Sparkles,
    },
  },
  en: {
    cigala: {
      ...
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-hero.webp",
      imageAlt: "Barca Egadi Sailing in the Egadi Islands",
      icon: Waves,
    },
    neel: {
      ...
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Catamaran-style trimaran sailing near Favignana",
      icon: Sparkles,
    },
  },
  es: {
    cigala: {
      ...
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-hero.webp",
      imageAlt: "Barca Egadi Sailing en las Islas Egadi",
      icon: Waves,
    },
    neel: {
      ...
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Trimarán con confort de catamarán navegando cerca de Favignana",
      icon: Sparkles,
    },
  },
  fr: {
    cigala: {
      ...
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-hero.webp",
      imageAlt: "Barca Egadi Sailing aux îles Égades",
      icon: Waves,
    },
    neel: {
      ...
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Trimaran au confort de catamaran en navigation près de Favignana",
      icon: Sparkles,
    },
  },
  de: {
    ...
    neel: {
      ...
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Trimaran mit Katamaran-Komfort bei Favignana",
      icon: Sparkles,
    },
  },
} satisfies Record<
