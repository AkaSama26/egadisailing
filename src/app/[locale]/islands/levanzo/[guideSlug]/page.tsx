...
import {
  getLevanzoGuideSlugForLocale,
  levanzoGuideSourceLinks,
  levanzoGuides,
  type LevanzoGuide,
  type LevanzoGuideCta,
  type LevanzoGuideSection,
} from "@/data/levanzo-guides";
...
const guideUi = {
  it: {
    ...
    compareTitle: "Scegli il modo giusto per vivere Levanzo dal mare",
    ...
    relatedTitle: "Altre pagine utili su Levanzo",
    relatedLabel: "Leggi la guida",
    sourcesEyebrow: "Fonti ufficiali e aggiornamenti",
    sourcesText:
      "Orari, visite guidate, regole dell'Area Marina Protetta e servizi possono cambiare: per i dettagli operativi rimandiamo sempre alle fonti ufficiali.",
  },
  en: {
    backLabel: "Levanzo",
    ...
    compareTitle: "Choose the right way to experience Levanzo by sea",
    ...
    relatedTitle: "More useful pages about Levanzo",
    relatedLabel: "Read the guide",
    sourcesEyebrow: "Official sources and updates",
    sourcesText:
      "Timetables, guided visits, Marine Protected Area rules and services may change: for practical details, always refer to official sources.",
  },
  es: {
    backLabel: "Levanzo",
    heroLabel: "Guía de Levanzo",
    ...
    compareTitle: "Elige la mejor forma de vivir Levanzo desde el mar",
    ...
    relatedTitle: "Más páginas útiles sobre Levanzo",
    relatedLabel: "Leer la guía",
    sourcesEyebrow: "Fuentes oficiales y actualizaciones",
    sourcesText:
      "Horarios, visitas guiadas, normas del Área Marina Protegida y servicios pueden cambiar: consulta siempre las fuentes oficiales.",
  },
  fr: {
    backLabel: "Levanzo",
    heroLabel: "Guide de Levanzo",
    ...
    compareTitle: "Choisissez la bonne façon de vivre Levanzo depuis la mer",
    ...
    relatedTitle: "Autres pages utiles sur Levanzo",
...
const compareExperiencesByLocale = {
  it: [
    ...
    },
    {
      ...
      description: "Trimarano con comfort da catamarano, chef, skipper, hostess e pranzo a base di prodotti locali.",
  ...
  en: [
    ...
    },
    {
      ...
      description: "Catamaran-style trimaran with skipper, hostess, private chef and a lunch based on local ingredients.",
      href: "/experiences/exclusive-experience",
      image: "/images/boats/neel-47/neel-47-tavolo-a-bordo.webp",
      meta: "Premium",
    },
  ...
  es: [
    ...
    },
    {
      ...
      description: "Barco reservado para grupos que quieren privacidad, comodidad y ritmo personal.",
      href: "/experiences/boat-exclusive-full-day",
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-bacio.webp",
      meta: "Privado",
    },
    {
      ...
      description: "Trimarán con confort de catamarán, patrón, azafata, chef privado y comida con productos locales.",
      href: "/experiences/exclusive-experience",
      image: "/images/boats/neel-47/neel-47-tavolo-a-bordo.webp",
      meta: "Premium",
    },
  ...
  fr: [
    ...
    },
    {
      ...
      description: "Un bateau réservé aux groupes qui veulent intimité, confort et rythme personnel.",
      href: "/experiences/boat-exclusive-full-day",
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-bacio.webp",
      meta: "Privé",
    },
    {
      ...
      description: "Trimaran au confort de catamaran avec skipper, hôtesse, chef privé et déjeuner à base de produits locaux.",
      href: "/experiences/exclusive-experience",
      image: "/images/boats/neel-47/neel-47-tavolo-a-bordo.webp",
      meta: "Premium",
    },
  ...
  de: [
    ...
    },
    {
      ...
      description: "Trimaran mit Katamaran-Komfort, Skipper, Hostess, privatem Chef und Mittagessen mit lokalen Produkten.",
      href: "/experiences/exclusive-experience",
      image: "/images/boats/neel-47/neel-47-tavolo-a-bordo.webp",
      meta: "Premium",
    },
...
const ctaCopyByLocale = {
  it: {
    cigala: {
      ...
      title: "Vuoi vivere Levanzo senza organizzare taxi mare, sentieri e coincidenze?",
      description:
        "Con Egadisailing parti da Trapani e la rotta viene scelta in base a vento, mare e comfort del gruppo. È il modo più semplice per vedere Levanzo dal mare, con soste bagno e snorkeling quando le condizioni lo permettono.",
      href: "/experiences/boat-shared-full-day",
      ...
      imageAlt: "Barca Egadi Sailing in navigazione alle Egadi",
      icon: Waves,
    },
    neel: {
      eyebrow: "Trimarano con comfort da catamarano",
      title: "Per una giornata più comoda tra Favignana e Levanzo, scegli il trimarano",
      description:
        "Spazi ampi, skipper, hostess, chef privato e pranzo a bordo: una soluzione premium per vivere le Egadi con un ritmo più lento e curato.",
      href: "/experiences/exclusive-experience",
      ...
      imageAlt: "Trimarano con comfort da catamarano alle Isole Egadi",
      icon: Sparkles,
    },
  },
  en: {
    cigala: {
      ...
      title: "Want to experience Levanzo without arranging water taxis, paths and connections?",
      description:
        "With Egadisailing you leave from Trapani and the route is chosen according to wind, sea and guest comfort. It is the simplest way to see Levanzo from the sea, with swim stops and snorkeling when conditions allow.",
      href: "/experiences/boat-shared-full-day",
      label: "View the 8-hour tour",
      secondaryHref: "/experiences/boat-exclusive-full-day",
      secondaryLabel: "See the private boat",
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-hero.webp",
      imageAlt: "Barca Egadi Sailing sailing in the Egadi Islands",
      icon: Waves,
    },
    neel: {
      eyebrow: "Catamaran-style trimaran",
      title: "For a more comfortable day between Favignana and Levanzo, choose the trimaran",
      description:
        "Wide spaces, skipper, hostess, private chef and lunch on board: a premium way to experience the Egadi Islands at a slower, more curated pace.",
      href: "/experiences/exclusive-experience",
      label: "View the gourmet experience",
      secondaryHref: "/experiences/charter",
      secondaryLabel: "View the charter",
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Catamaran-style trimaran in the Egadi Islands",
      icon: Sparkles,
    },
  },
  es: {
    cigala: {
      ...
      title: "¿Quieres vivir Levanzo sin organizar taxis acuáticos, senderos y conexiones?",
      description:
        "Con Egadisailing sales desde Trapani y la ruta se elige según viento, mar y comodidad del grupo. Es una forma sencilla de ver Levanzo desde el mar, con baños y snorkel cuando las condiciones lo permiten.",
      href: "/experiences/boat-shared-full-day",
      label: "Ver la excursión de 8 horas",
      secondaryHref: "/experiences/boat-exclusive-full-day",
      secondaryLabel: "Ver el tour privado",
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-hero.webp",
      imageAlt: "Barca Egadi Sailing navegando en las Islas Egadi",
      icon: Waves,
    },
    neel: {
      eyebrow: "Trimarán con confort de catamarán",
      title: "Para un día más cómodo entre Favignana y Levanzo, elige el trimarán",
      description:
        "Espacios amplios, patrón, azafata, chef privado y comida a bordo: una opción premium para vivir las Egadi con un ritmo más lento y cuidado.",
      href: "/experiences/exclusive-experience",
      label: "Ver la experiencia gourmet",
      secondaryHref: "/experiences/charter",
      secondaryLabel: "Ver el charter",
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Trimarán con confort de catamarán en las Islas Egadi",
      icon: Sparkles,
    },
  },
  fr: {
    cigala: {
      ...
      title: "Envie de vivre Levanzo sans organiser bateaux-taxis, sentiers et correspondances ?",
      description:
        "Avec Egadisailing, vous partez de Trapani et l'itinéraire est choisi selon le vent, la mer et le confort du groupe. C'est une façon simple de voir Levanzo depuis la mer, avec baignades et snorkeling lorsque les conditions le permettent.",
      href: "/experiences/boat-shared-full-day",
      label: "Voir l'excursion de 8 heures",
      secondaryHref: "/experiences/boat-exclusive-full-day",
      secondaryLabel: "Voir le tour privé",
      image: "/images/boats/cigala-bertinetti-34-offshore-open/cigala-bertinetti-34-offshore-open-hero.webp",
      imageAlt: "Barca Egadi Sailing en navigation aux îles Égades",
      icon: Waves,
    },
    neel: {
      eyebrow: "Trimaran au confort de catamaran",
      title: "Pour une journée plus confortable entre Favignana et Levanzo, choisissez le trimaran",
      description:
        "Grands espaces, skipper, hôtesse, chef privé et déjeuner à bord : une option premium pour vivre les Égades à un rythme plus lent et soigné.",
      href: "/experiences/exclusive-experience",
      label: "Voir l'expérience gourmet",
      secondaryHref: "/experiences/charter",
      secondaryLabel: "Voir le charter",
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Trimaran au confort de catamaran aux îles Égades",
      icon: Sparkles,
    },
  },
  de: {
    ...
    neel: {
      eyebrow: "Trimaran mit Katamaran-Komfort",
      ...
      image: "/images/boats/neel-47/neel-47-favignana.webp",
      imageAlt: "Trimaran mit Katamaran-Komfort auf den Ägadischen Inseln",
      icon: Sparkles,
    },
  },
} satisfies Record<
  GuideLocale,
  Record<
    Exclude<LevanzoGuideCta, "compare">,
    {
      eyebrow: string;
      title: string;
      description: string;
...
function getGuideUrl(locale: GuideLocale, slug: string): string {
  return localizedPath(locale, `/islands/levanzo/${slug}`);
}
  ...
  const graph: unknown[] = [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Levanzo", item: `${base}${localizedPath(locale, "/islands/levanzo")}` },
...
export default async function LevanzoGuidePage({
  params,
}: {
  params: Promise<{ locale: string; guideSlug: string }>;
}) {
  ...
  const relatedGuides = guide.relatedSlugs
    ...
    .filter((item): item is LevanzoGuide => Boolean(item));
    ...
    <section className="relative isolate min-h-[82svh] overflow-hidden bg-[#071934] px-4 pb-12 pt-28 text-white sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex min-h-[calc(82svh-10rem)] max-w-7xl flex-col justify-center">
        <div className="mb-8 flex flex-wrap items-center gap-3 text-sm font-semibold">
          <Link
            href={localizedPath(locale, "/islands/levanzo")}
        ...
        <dl className="mt-10 grid max-w-5xl gap-3 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <section className="bg-[#071934] px-4 py-10 text-white sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          {levanzoGuideSourceLinks.map((source) => (
            <a
              key={source.href}
              href={source.href}
              target="_blank"
