...
function getGuideUrl(locale: GuideLocale, slug: string): string {
  return `/${locale}/islands/levanzo/${slug}`;
}
  ...
  const graph: unknown[] = [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Levanzo", item: `${base}/${locale}/islands/levanzo` },
