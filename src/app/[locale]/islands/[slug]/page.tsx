...
> = {
  favignana: {
    title: {
      ...
      de: "Favignana mit dem Boot ab Trapani: Cala Rossa und Cala Azzurra",
    },
    description: {
  ...
  levanzo: {
    title: {
      ...
      en: "Levanzo by Boat from Trapani: Cala Fredda and Cala Minnola",
      es: "Levanzo en barco desde Trapani: Cala Fredda y Cala Minnola",
      fr: "Levanzo en bateau depuis Trapani : Cala Fredda, Cala Minnola et excursions aux Égades",
      de: "Levanzo mit dem Boot ab Trapani: Cala Fredda und Cala Minnola",
    },
    description: {
      it: "Guida a Levanzo in barca: Cala Fredda, Cala Minnola, Grotta del Genovese e le soste migliori per snorkeling alle Egadi.",
      en: "Guide to Levanzo by boat from Trapani: Cala Fredda, Cala Minnola, Grotta del Genovese and snorkelling stops in the Egadi Islands.",
      es: "Guía de Levanzo en barco desde Trapani: Cala Fredda, Cala Minnola, Grotta del Genovese y mejores paradas para snorkel en las Islas Egadi.",
      fr: "Guide de Levanzo en bateau depuis Trapani : Cala Fredda, Cala Minnola, Grotte du Genovese et meilleures haltes de snorkeling aux îles Égades.",
      de: "Guide zu Levanzo mit dem Boot ab Trapani: Cala Fredda, Cala Minnola, Grotta del Genovese und die besten Schnorchelstopps auf den Ägadischen Inseln.",
    },
  },
  marettimo: {
    title: {
      it: "Marettimo in barca: grotte marine, Cala Bianca e tour Egadi",
      en: "Marettimo by Boat from Trapani: Sea Caves and Cala Bianca",
      es: "Marettimo en barco desde Trapani: cuevas marinas y Cala Bianca",
      fr: "Marettimo en bateau depuis Trapani : grottes marines, Cala Bianca et charter Égades",
      de: "Marettimo mit dem Boot ab Trapani: Meereshöhlen und Cala Bianca",
    },
    description: {
      ...
      en: "Guide to Marettimo by boat from Trapani: sea caves, Cala Bianca, Punta Troia and routes to the wildest Egadi island.",
      es: "Guía de Marettimo en barco desde Trapani: cuevas marinas, Cala Bianca, Punta Troia y rutas de charter para la isla más salvaje de las Egadi.",
      fr: "Guide de Marettimo en bateau depuis Trapani : grottes marines, Cala Bianca, Punta Troia et itinéraires pour découvrir l'île la plus sauvage des Égades.",
      de: "Guide zu Marettimo mit dem Boot ab Trapani: Meereshöhlen, Cala Bianca, Punta Troia und Routen zur wildesten Insel der Ägadischen Inseln.",
    },
  },
};
...
export async function generateMetadata({
  ...
  if (!isIslandSlug(slug)) return { title: "Not Found" };
  const seo = islandSeo[slug];
