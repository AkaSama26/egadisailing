...
export const RATE_LIMIT_SCOPES = {
  ...
  COOKIE_CONSENT_IP: "COOKIE_CONSENT_IP",
  BOOKING_CALENDAR_IP: "BOOKING_CALENDAR_IP",
  PUBLIC_WEATHER_IP: "PUBLIC_WEATHER_IP",
  EXPERIENCE_PRESENCE_IP: "EXPERIENCE_PRESENCE_IP",
  ...
  OVERRIDE_CHECK_IP: "OVERRIDE_CHECK_IP",
  OVERRIDE_REMINDERS_CRON_IP: "OVERRIDE_REMINDERS_CRON_IP",
  OVERRIDE_DROPDEAD_CRON_IP: "OVERRIDE_DROPDEAD_CRON_IP",
  OVERRIDE_RECONCILE_CRON_IP: "OVERRIDE_RECONCILE_CRON_IP",
  REFUND_RETRY_CRON_IP: "REFUND_RETRY_CRON_IP",
  EMAIL_OUTBOX_CRON_IP: "EMAIL_OUTBOX_CRON_IP",
  ADMIN_OVERRIDE_ACTION: "ADMIN_OVERRIDE_ACTION",
  ADMIN_RECEIPT_ACTION: "ADMIN_RECEIPT_ACTION",
} as const;
